...
public class Articulo {
	 ...
	 */
	Articulo(String descripcion, double precioCompra, double precioVenta, int stock, TipoIva iva) throws ValorNoValidoException, IvaInvalidoException {
	 ...
	 * @throws IvaInvalidoException
	 */
	void set(String descripcion, double precioCompra, double precioVenta, int stock, TipoIva iva) throws ValorNoValidoException, IvaInvalidoException {
		setDescripcion(descripcion);
		setPrecioCompra(precioCompra);
		setPrecioVenta(precioVenta);
		setStock(stock);
