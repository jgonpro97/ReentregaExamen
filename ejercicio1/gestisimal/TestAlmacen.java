...
public class TestAlmacen {
  ...
  /**
   * Metodo para capturar la excepciones e introducir datos para añadir un
   * articulo
   */
  static void annadir() {
    try {
  ...
  static void decrementar() {
    try {
      ...
      almacen.decrementarStock(codigo, Teclado.leerEntero("" + "En cuanto quieres decrementar el stock: "));
